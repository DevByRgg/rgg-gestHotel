...
<nav class="navbar bg-info fixed-top">
		...
		<div class="dropdown">
			...
			<button class="btn btn-outline-light dropdown-toggle" type="button" id="dropdownMenuButton" title="Capacidad" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  			...
  			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    			<a class="dropdown-item" href="/hotel/findByCapacidad?idHotel=${hotel.id}&capacidad=2">2 ó más</a>
    			<a class="dropdown-item" href="/hotel/findByCapacidad?idHotel=${hotel.id}&capacidad=3">3 ó más</a>
    			<a class="dropdown-item" href="/hotel/findByCapacidad?idHotel=${hotel.id}&capacidad=4">4 ó más</a>
    			<a class="dropdown-item" href="/hotel/findByCapacidad?idHotel=${hotel.id}&capacidad=5">5 ó más</a>
    			<a class="dropdown-item" href="/hotel/findByCapacidad?idHotel=${hotel.id}&capacidad=6">6 ó más</a>
  			</div>
		</div>
		
						
		<a type="button" class="btn btn-outline-light" href="/hotel/findByAireAcondicionado?idHotel=${hotel.id}">
	...
	<div class="float-right">
		...
		<a type="button" class="btn ml-2" href="/hotel/verCestaCompra">
			<c:choose>
